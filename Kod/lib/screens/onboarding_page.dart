          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  children: [
                    _buildRadioTile("Ağız, Diş ve Çene Radyolojisi"),
                    _buildDivider(),                    
                    _buildRadioTile("Endodonti"),
                    _buildDivider(),
                    _buildRadioTile("Ağız, Diş ve Çene Cerrahisi"),
                    _buildDivider(),
                    _buildRadioTile("Çocuk Diş Hekimliği"),
                    _buildDivider(),
                    _buildRadioTile("Periodontoloji"),
                    _buildDivider(),                    
                    _buildRadioTile("Ortodonti"),
                    _buildDivider(),
                    _buildRadioTile("Protetik Diş Tedavisi"),
                    _buildDivider(),
                    _buildRadioTile("Restoratif Diş Tedavisi"),
                  ],
                ),
              ),
